...
export const SERVICOS_DATA: ServicoData[] = [
  {
    ...
    spot: 'Demandas de maior porte são contratadas por proposta específica, com escopo, premissas, cronograma, orçamento e processo de alteração formalizados.',
  ...
  },
  {
    ...
    headline: 'Construção de unidades corporativas e comerciais, do planejamento à entrega técnica.',
    ...
    spot: 'A implantação é contratada por projeto ou programa de expansão, com escopo, marcos, orçamento e responsabilidades formalizados.',
