 ...
 *
 * Inline em vez de biblioteca de ícones: é o único ícone de marca do site e
 * herda a cor via `currentColor`, então não justifica uma dependência nova.
 * Decorativo por padrão (`aria-hidden`) — quem dá nome ao controle é o texto
 * do botão ou o `aria-label` do link que o contém.
 */
