# Áudio do João — 22/09/2026 — comunicado a cada atualização

Transcrição literal, colada no chat:

> (0:00) E outra coisa, a gente precisa, quando subir a atualização, (0:05) a gente precisa enviar
> um comunicado para eles informando o que mudou, entendeu? (0:09) Que, por exemplo, eles estão...
> Um exemplo, tá? (0:13) Eles estão colocando lá o prestador como a contratar. (0:18) Porque não
> tem outra opção lá da equipe ou do prestador que eles escolheram. (0:24) Aí vai subir uma
> atualização onde a gente vai liberar para eles escreverem manualmente.
