...
| **J4 — SLAs de aprovação/faturamento** | Dois contadores: dias sem OS aprovada (desde a liberação) e dias desde a OS aprovada até faturar. Amarelo/vermelho do SLA 2 definidos hoje (15/09: 15/30 dias); SLA 1 ainda sem meta, mockup assume 20/30 como suposição | Junto com a J4 | Meta do SLA 1, ainda não respondida pelo cliente |
